...
Game_BattlerBase.prototype.meetAllEquipRequirements = function(item, slot=-1) {
  ...
  if (slot > -1) if (this.equips().some((e, i) => e && e.groupType === item.groupType && (e.baseItemId === item.baseItemId || (e.atypeId === 11 && item.atypeId === 11)) && i !== slot && e !== item)) { console.log(item.name, this.equips()); return false; } // No duplicates; includes gloves
